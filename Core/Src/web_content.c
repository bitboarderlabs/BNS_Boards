...
".io-grid{display:grid;grid-template-columns:1fr 1fr 1fr 1fr;gap:4px;font-size:0.85em}"
".io-grid input{width:100%;padding:3px}"
"</style></head><body>"
"<h1>Settings</h1>"
"<nav><a href='/'>Dashboard</a><a href='/settings'>Settings</a><a href='/apps'>Apps</a></nav>"
"<div id='msg'></div>"
...
"<div class='io-grid'><b>Name</b><b>ON Value</b><b>OFF Value</b><b>String?</b></div>"
"<div id='ioGrid'></div>"
"</div>"
...
"q('mqtt_broker_port').value=d.mqtt_broker_port;"
...
"q('mqtt_keepalive_sec').value=d.mqtt_keepalive_sec;"
"q('mqtt_reconnect_ms').value=d.mqtt_reconnect_ms;"
"q('mqtt_analog_interval_s').value=d.mqtt_analog_interval_s;"
"var h='';if(d.io)d.io.forEach(function(io){"
"h+='<div class=\"io-grid\">'+"
"'<input data-i=\"'+io.i+'\" data-f=\"n\" value=\"'+io.n+'\">'+"
"'<input data-i=\"'+io.i+'\" data-f=\"on\" value=\"'+io.on+'\">'+"
"'<input data-i=\"'+io.i+'\" data-f=\"off\" value=\"'+io.off+'\">'+"
"'<input type=\"checkbox\" data-i=\"'+io.i+'\" data-f=\"str\"'+(io.str?' checked':'')+'>'+'"
"'</div>'});"
...
"h+='<div class=\"card\"><h2>App '+i+' <span class=\"'+state+'\">'+label+'</span></h2>';"
